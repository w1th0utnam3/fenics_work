	...
	int cell_orientation)
{
	...
	for (int iq = 0; iq < 5; ++iq)
    {
		...
		const double factor = sp[73] * weights5[iq];

        alignas(32) double sv5[8];
        sv5[0] = sp[67] * w0;
        sv5[1] = sp[68] * w0;
        sv5[2] = sp[69] * w0;
        sv5[3] = sp[70] * w0;
		...
		fw[iq][0] = sv5[0] * factor;
		fw[iq][1] = sv5[1] * factor;
		fw[iq][2] = sv5[2] * factor;
		fw[iq][3] = sv5[3] * factor;
		fw[iq][4] = sv5[4] * factor;
		fw[iq][5] = sv5[5] * factor;
		fw[iq][6] = sv5[6] * factor;
		fw[iq][7] = sv5[7] * factor;
	}
    ...
    for (int iq = 0; iq < 5; ++iq)
    {
        ...
        for (int i = 0; i < 8; ++i)
            TF0[i] = fw[iq][0] * FE15_C0_D100_Q5[0][iq][i];
        for (int i = 0; i < 8; ++i)
            for (int j = 0; j < 8; ++j)
        ...
        for (int i = 0; i < 8; ++i)
            TF1[i] = fw[iq][1] * FE15_C0_D100_Q5[0][iq][i];
        for (int i = 0; i < 8; ++i)
            for (int j = 0; j < 8; ++j)
        ...
        for (int i = 0; i < 8; ++i)
            TF2[i] = fw[iq][2] * FE15_C0_D100_Q5[0][iq][i];
        for (int i = 0; i < 8; ++i)
            for (int j = 0; j < 8; ++j)
        ...
        for (int i = 0; i < 8; ++i)
            TF3[i] = fw[iq][1] * FE15_C0_D010_Q5[0][iq][i];
        for (int i = 0; i < 8; ++i)
            for (int j = 0; j < 8; ++j)
        ...
        for (int i = 0; i < 8; ++i)
            TF4[i] = fw[iq][3] * FE15_C0_D010_Q5[0][iq][i];
        for (int i = 0; i < 8; ++i)
            for (int j = 0; j < 8; ++j)
        ...
        for (int i = 0; i < 8; ++i)
            TF5[i] = fw[iq][4] * FE15_C0_D010_Q5[0][iq][i];
        for (int i = 0; i < 8; ++i)
            for (int j = 0; j < 8; ++j)
        ...
        for (int i = 0; i < 8; ++i)
            TF6[i] = fw[iq][2] * FE15_C0_D001_Q5[0][iq][i];
        for (int i = 0; i < 8; ++i)
            for (int j = 0; j < 8; ++j)
        ...
        for (int i = 0; i < 8; ++i)
            TF7[i] = fw[iq][4] * FE15_C0_D001_Q5[0][iq][i];
        for (int i = 0; i < 8; ++i)
            for (int j = 0; j < 8; ++j)
        ...
        for (int i = 0; i < 8; ++i)
            TF8[i] = fw[iq][5] * FE15_C0_D001_Q5[0][iq][i];
        for (int i = 0; i < 8; ++i)
            for (int j = 0; j < 8; ++j)
