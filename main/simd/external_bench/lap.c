...
void tabulate_tensor_laplace_p2tet_coefficient_p1tet_0_cell_integral_0_otherwise(ufc_scalar_t* restrict A, const ufc_scalar_t* const* w,
...
#define A_SIZE 100
#define A_SIZE_EXPANDED (100 % 4 == 0) ? 100 : 100 - (100 % 4) + 4
#define W_DIM1_SIZE 1
#define W_DIM2_SIZE 4
#define DOF_DIM1_SIZE 4
#define DOF_DIM2_SIZE 3
    ...
    double* coord_vals)
{
    ...
    double acc[4] = { 0.0 };
    for(int i = 0; i < n; ++i) {
        tabulate_tensor_laplace_p2tet_coefficient_p1tet_0_cell_integral_0_otherwise((double*)&A[0], (const double* const*)&w_ptrs[0], (const double*)&coords[0][0], 0);
...
int main()
{
    ...
    double res = _test_runner_tabulate_tensor_laplace_p2tet_coefficient_p1tet_0_cell_integral_0_otherwise(200*200*200, w_vals, coord_vals);
    printf("Rounding:\t%f\n", res);
}
