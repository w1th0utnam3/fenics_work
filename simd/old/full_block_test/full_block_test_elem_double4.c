...
double4 fabs4(double4 arg)
{
    for (int i = 0; i < 4; ++i) arg[i] = fabs(arg[i]);
    return arg;
}

void tabulate_tensor_elem(
	double4* restrict A, 
	const double4* const* w,
	...
	int cell_orientation)
{
    ...
    const double4 J_c4 = coordinate_dofs[1] * FE9_C0_D001_Q5[0][0][0] + coordinate_dofs[7] * FE9_C0_D001_Q5[0][0][1];
    const double4 J_c8 = coordinate_dofs[2] * FE9_C0_D001_Q5[0][0][0] + coordinate_dofs[11] * FE9_C0_D001_Q5[0][0][1];
    const double4 J_c5 = coordinate_dofs[1] * FE9_C0_D001_Q5[0][0][0] + coordinate_dofs[10] * FE9_C0_D001_Q5[0][0][1];
    const double4 J_c7 = coordinate_dofs[2] * FE9_C0_D001_Q5[0][0][0] + coordinate_dofs[8] * FE9_C0_D001_Q5[0][0][1];
    const double4 J_c0 = coordinate_dofs[0] * FE9_C0_D001_Q5[0][0][0] + coordinate_dofs[3] * FE9_C0_D001_Q5[0][0][1];
    const double4 J_c1 = coordinate_dofs[0] * FE9_C0_D001_Q5[0][0][0] + coordinate_dofs[6] * FE9_C0_D001_Q5[0][0][1];
    const double4 J_c6 = coordinate_dofs[2] * FE9_C0_D001_Q5[0][0][0] + coordinate_dofs[5] * FE9_C0_D001_Q5[0][0][1];
    const double4 J_c3 = coordinate_dofs[1] * FE9_C0_D001_Q5[0][0][0] + coordinate_dofs[4] * FE9_C0_D001_Q5[0][0][1];
    const double4 J_c2 = coordinate_dofs[0] * FE9_C0_D001_Q5[0][0][0] + coordinate_dofs[9] * FE9_C0_D001_Q5[0][0][1];
